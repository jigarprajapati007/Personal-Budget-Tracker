...
import { updateListdata } from "../../redux/feature/budget.tsx";
import { useDispatch } from "react-redux";
import Box from "@mui/material/Box";
import MenuItem from "@mui/material/MenuItem";
import FormControl from "@mui/material/FormControl";
import Select, { SelectChangeEvent } from "@mui/material/Select";
import { userContext } from "../BudgetList/ListOfUserBudget.tsx";
import UserEntireObj from "../../service/UserSchema.tsx";
import { Toaster } from "../Toaster/Toaster.tsx";

export const EditUserForm = () => {
  let user = useContext(userContext) as UserEntireObj;
  ...
  return (
    <div>
      <Formik
        initialValues={{
          income: user.userData.income,
          expense: user.userData.expense,
        ...
        onSubmit={(values) => {
          setOpen(true)
          dispatch(updateListdata(values));
          setTimeout(() => {
            user.setEmptyToUserData()
          }, 500);
        }}
      >
        {({
